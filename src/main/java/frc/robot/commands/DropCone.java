...
public class DropCone extends SequentialCommandGroup {
  ...
  public DropCone(DriveSystem m_drivesystem, ShoulderSystem m_shouldersystem, ArmSystem m_armsystem, ClampSystem m_clampsystem, switchesSystem m_switchessystem, LimelightSystem m_limelight) {
    // int[] shoulder_rotation = new int[]{350,550,660};
    // int[] arm_extension = new int[]{100,6000,8400};
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new RotateShoulderToValue(m_shouldersystem, 800),
