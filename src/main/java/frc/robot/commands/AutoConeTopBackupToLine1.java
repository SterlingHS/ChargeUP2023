...
public class AutoConeTopBackupToLine1 extends SequentialCommandGroup {
  /** Creates a new AutoConeBackupToLine. */
  public AutoConeTopBackupToLine1(DriveSystem m_drivesystem, ShoulderSystem m_shouldersystem, ArmSystem m_armsystem, ClampSystem m_clampsystem, switchesSystem m_switchsystem, LimelightSystem m_limelightsystem) {
